...
public class ProcessedMapWktDeduplicatorTopology {
    ...
    public Topology buildTopology() {
        ...
        KStream<String, ProcessedMap<String>> inputStream = builder.stream(props.getKafkaTopicProcessedMapWKT(),
        ...
        KStream<String, ProcessedMap<String>> deduplicatedStream = inputStream.process(
