...
import us.dot.its.jpo.deduplicator.deduplicator.processors.OdeSpatJsonProcessor;
import us.dot.its.jpo.ode.model.OdeMessageFrameData;

public class OdeSpatJsonProcessorSupplier
    ...
    public OdeSpatJsonProcessorSupplier(String storeName, DeduplicatorProperties props) {
    ...
    public Processor<String, OdeMessageFrameData, String, OdeMessageFrameData> get() {
        return new OdeSpatJsonProcessor(storeName, props);
    }
}
